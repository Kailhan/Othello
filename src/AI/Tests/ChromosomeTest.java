...
public class ChromosomeTest {
    ...
    public static void main(String[] args) {
        ...
        int boardSize = (int)Math.sqrt(chromosome.length - WEIGHT_POLY_SIZE);
        EvaluationFunction eval = new EvaluationFunction(new Board(boardSize));
        eval.setChromosome(chromosome);
        GenericTest.test(eval, new Stupid(), 100, boardSize);
        ...
        GenericTest.test(new Stupid(), eval, 100, boardSize);
        System.out.println("GenericTest.getPlayer1Wins()" + GenericTest.getPlayer1Wins() + " GenericTest.getPlayer2Wins()" + GenericTest.getPlayer2Wins());
